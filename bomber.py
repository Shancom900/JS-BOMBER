...
def bann_text():
   ...
   █████                 ██🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴
   ██▒▒██                ██      WELCOME YOU LEGEND!
   ██  ██        ██   ██ ██ THIS FREE TOOL IS MADE BY @SJ_TOOLS
   █████▒  ████  ███ ███ █████
   ██▒▒██ ██  ██ ██▒█▒██ ██▒▒██ 🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴
   ██  ██ ██  ██ ██ ▒ ██ ██  ██
   █████▒ ▒████▒ ██   ██ █████▒
...
def check_for_updates():
    ...
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("SJ-Bomber is up-to-date")
        mesgdcrt.GeneralMessage("Starting SJ-Bomber")
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("SJ-Bomber was created by SHANU&JERRY")
    mesgdcrt.SuccessMessage("SJ-Bomber was modified by SJ_TOOLS")
...
description = """RevengeBomber - Your Friendly Spammer Application

RevengeBomber can be used for many purposes which incudes -
\t Exposing the vulnerable APIs over Internet
\t Friendly Spamming
\t Testing Your Spam Detector and more ....

RevengeBomber is not intented for malicious uses.
"""
